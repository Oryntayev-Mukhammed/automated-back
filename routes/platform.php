...
Route::screen('cases', CaseListScreen::class)
    ->name('platform.cases')
    ->breadcrumbs(fn (Trail $trail) => $trail->parent('platform.index')->push('Cases'));

Route::screen('cases/create', CaseEditScreen::class)
    ->name('platform.cases.create')
    ->breadcrumbs(fn (Trail $trail) => $trail->parent('platform.cases')->push('Create'));

Route::screen('cases/{case}/edit', CaseEditScreen::class)
    ->name('platform.cases.edit')
    ->breadcrumbs(fn (Trail $trail, \Modules\Case\Entities\CaseModel $case) => $trail->parent('platform.cases')->push($case->property_title));

// Posts
Route::screen('posts', PostListScreen::class)
    ->name('platform.posts')
    ->breadcrumbs(fn (Trail $trail) => $trail->parent('platform.index')->push('Posts'));

Route::screen('posts/create', PostEditScreen::class)
    ->name('platform.posts.create')
    ->breadcrumbs(fn (Trail $trail) => $trail->parent('platform.posts')->push('Create'));
